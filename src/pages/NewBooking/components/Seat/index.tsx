...
const Seat: FC<props> = ({seatData,handleClick,rowIndex,seatIndex}) => {
    ...
    return (
        <div>
            <div onClick={() => handleClick(seatData,rowIndex,seatIndex)} className={`flex justify-center items-center w-12 h-12 m-2 border border-white rounded-xl hover:opacity-30 cursor-pointer ${bgColor} ${textColor}`}>
